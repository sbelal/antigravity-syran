...
* **Example:** The installation script at `bin/install.js` supports options to target either local workspace directories or the global user profile agent directory.
---
